...
exports.generateVideoUrl = exports.deleteCourse = exports.getAdminAllCourse = exports.addReplyReview = exports.addReview = exports.AddAnswer = exports.addQuestion = exports.getCoursebyUser = exports.getAllCourses = exports.getSingleCourse = exports.editCourse = exports.uploadCourse = void 0;
...
exports.getCoursebyUser = (0, catchAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        const courseId = req.params.id;
        const courseExists = userCourseList?.find((course) => {
            return course._id.toString() === courseId.toString();
        });
        if (!courseExists)
            return next(new ErrorHandler_1.default("You are not eligile to access this course", 404));
...
exports.addReview = (0, catchAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (!courseExists)
            return next(new ErrorHandler_1.default("You are not aligible to access this avatar", 404));
        const course = await course_model_1.default.findById(courseId);
...
exports.addReplyReview = (0, catchAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
...
exports.getAdminAllCourse = (0, catchAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
